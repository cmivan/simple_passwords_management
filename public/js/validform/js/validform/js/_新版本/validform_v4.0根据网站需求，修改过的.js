...
(function($){
	...
	$.Datatype={
		...
		"*6-16":/^.{6,16}$/,
		"n":/^\d+$/,
		"n1-10":/^[1-9]+[0-9]{0,9}$/, //by cmivan for number
		"s":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/m,
		"s2-6":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{2,6}$/, //by cmivan for name
		"s4-28":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{4,28}$/, //by cmivan for title
		"s5-70":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{5,70}$/, //by cmivan for title
		"s6-18":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{6,18}$/,
		"q":/^[0-9]{5,11}$/,   //by cmivan for qq
		"d":/^\d{4}-\d{2}-\d{2}$/, //by cmivan for date
		"sm":/^(\d{6})(18|19|20)?(\d{2})([01]\d)([0123]\d)(\d{3})(\d|X)?$/, //by cmivan for shi ming yan zheng
		"p":/^[0-9]{4}$/,
		//"p":/^[0-9]{6}$/,
